...
function beker_tm_news_pagination(element) {
  ...
  var html =
    '<div class="my_numbers"><div class="in"><a class="prev" href="#"><span></span></a><a class="next" href="#"><span></span></a><div class="wrapper"><ul>';
  for (var i = 0; i < liCount; i++) {
    html +=
      '<li><a href="#' +
      element.find("li:eq(" + i + ")").attr("data-hash") +
      '">' +
      (i + 1) +
      ".</a></li>";
  }
  ...
  if (myCursor.length) {
    if ($("body")) {
      ...
      (window.onmousemove = function (s) {
        ...
        $("body").on(
          "mouseenter",
          "a, .melek_tm_topbar .trigger, .cursor-pointer",
          function () {
            e.classList.add("cursor-hover"), t.classList.add("cursor-hover");
          }
        ),
